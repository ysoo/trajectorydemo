...
const MarketSummary: React.FC = () => {
  return (
    <div className="bg-gray-900 border-t border-yellow-400 rounded-lg p-3 mt-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-xs text-gray-400 font-mono">Last Updated: {new Date().toLocaleTimeString()}</span>
        </div>
      </div>
